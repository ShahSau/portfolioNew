...
const EmailListBlock: FC = () => (
  <>
    <Block className="group col-span-12 flex flex-col items-center gap-4 md:col-span-4 text-zinc-600">
      <MdOutlineSmartphone className="text-5xl relative top-4 transition-all duration-300 ease-in-out group-hover:-translate-y-12 group-hover:opacity-0" />
    ...
    <Block className="group col-span-12 flex flex-col items-center gap-4 md:col-span-4 text-zinc-600">
      <IoMdMail className="text-5xl relative top-4 transition-all duration-300 ease-in-out group-hover:-translate-y-12 group-hover:opacity-0" />
      <p className="text-center transition-all duration-200  opacity-0 text-lg text-zinc-700 group-hover:-translate-y-4 group-hover:opacity-100">
        shahriarksaurov@gmail.com
      </p>
    </Block>
    <Block className="group col-span-12 flex flex-col items-center gap-4 md:col-span-4 text-zinc-600">
      <IoMdDownload className="text-3xl relative top-4 transition-all duration-300 ease-in-out group-hover:-translate-y-12 group-hover:opacity-0" />
      <a
